...
public class Char3DBarWeekAction extends ActionSupport {
	...
	public JFreeChart getChart() {
		...
		String begindate=TimeUtils.getMondayOfThisWeek();
		String enddate=TimeUtils.getSundayOfThisWeek();
		String chartitle="QTP Report status From "+begindate+" to "+enddate;
		
			
		CategoryDataset dataset=createDataset(TimeUtils.getCurrentWeekDays());
	//createBarChart3D
